...
async function main() {
    ...
    const coursesData = [
        { title: 'JEE Main Foundation', slug: 'jee-main-foundation', category: 'Foundation', description: 'Strong foundation for JEE Main.', duration: '1 Year', feeStructure: '₹40,000' },
        { title: 'NEET Foundation', slug: 'neet-foundation', category: 'Foundation', description: 'Early preparation for NEET.', duration: '1 Year', feeStructure: '₹40,000' },
        { title: 'Class 11 Physics Mastery', slug: 'class-11-physics-mastery', category: '11-12 Science', description: 'In-depth Physics for Class 11.', duration: '1 Year', feeStructure: '₹20,000' },
        { title: 'Class 11 Chemistry Expert', slug: 'class-11-chemistry-expert', category: '11-12 Science', description: 'Comprehensive Chemistry.', duration: '1 Year', feeStructure: '₹20,000' },
        { title: 'Class 11 Math Advanced', slug: 'class-11-math-advanced', category: '11-12 Science', description: 'Mathematics for competitive exams.', duration: '1 Year', feeStructure: '₹20,000' },
        { title: 'Class 11 Biology Pro', slug: 'class-11-biology-pro', category: '11-12 Science', description: 'Detailed Botany and Zoology.', duration: '1 Year', feeStructure: '₹20,000' },
        { title: 'Class 12 Physics Crash Course', slug: 'class-12-physics-crash', category: '11-12 Science', description: 'Quick revision for boards.', duration: '3 Months', feeStructure: '₹10,000' },
        { title: 'Class 12 Chemistry Crash Course', slug: 'class-12-chemistry-crash', category: '11-12 Science', description: 'Board focused chemistry.', duration: '3 Months', feeStructure: '₹10,000' },
        { title: 'Class 12 Math Crash Course', slug: 'class-12-math-crash', category: '11-12 Science', description: 'Board focused mathematics.', duration: '3 Months', feeStructure: '₹10,000' },
        { title: 'Target JEE Advanced', slug: 'target-jee-advanced', category: 'Target Batch', description: 'For droppers aiming for IITs.', duration: '1 Year', feeStructure: '₹80,000' },
        { title: 'Target NEET AIIMS', slug: 'target-neet-aiims', category: 'Target Batch', description: 'For droppers aiming for top medical colleges.', duration: '1 Year', feeStructure: '₹80,000' },
        { title: 'MHT-CET Complete Guide', slug: 'mht-cet-complete', category: 'State Board', description: 'Maharashtra state engineering entrance.', duration: '6 Months', feeStructure: '₹25,000' },
        { title: 'GUJCET Special', slug: 'gujcet-special', category: 'State Board', description: 'Gujarat state entrance preparation.', duration: '6 Months', feeStructure: '₹25,000' },
        { title: 'BITSAT Mock Series', slug: 'bitsat-mock-series', category: 'Test Series', description: 'Online test series for BITSAT.', duration: '2 Months', feeStructure: '₹5,000' },
        { title: 'NDA Mathematics', slug: 'nda-math', category: 'Defense', description: 'Math preparation for NDA.', duration: '6 Months', feeStructure: '₹15,000' },
        { title: 'NDA General Ability', slug: 'nda-gat', category: 'Defense', description: 'GAT preparation for NDA.', duration: '6 Months', feeStructure: '₹15,000' },
        { title: 'Class 10 Board Booster', slug: 'class-10-boards', category: 'Board Prep', description: 'Score 95+ in Class 10.', duration: '1 Year', feeStructure: '₹30,000' },
        { title: 'NTSE Stage 1', slug: 'ntse-stage-1', category: 'Scholarship', description: 'Preparation for NTSE scholarship.', duration: '6 Months', feeStructure: '₹10,000' },
        { title: 'Olympiad Mathematics', slug: 'olympiad-math', category: 'Scholarship', description: 'PRMO and RMO preparation.', duration: '1 Year', feeStructure: '₹15,000' },
        { title: 'KVPY Stream SA', slug: 'kvpy-sa', category: 'Scholarship', description: 'Science aptitude preparation.', duration: '6 Months', feeStructure: '₹12,000' },
    ];
