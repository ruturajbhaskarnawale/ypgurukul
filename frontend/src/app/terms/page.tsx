      ...
      <div className="max-w-4xl mx-auto px-12">
        <FadeIn>
          <h1 className="text-6xl font-black uppercase tracking-tighter-editorial text-white mb-12">
            Terms of <span className="opacity-20 italic">Service</span>
          </h1>
          <div className="prose prose-invert max-w-none text-white/60 lowercase leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-widest">Enrollment</h2>
            <p className="mb-8">enrollment is subject to verification of academic credentials and adherence to our code of conduct.</p>
            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-widest">Curriculum</h2>
