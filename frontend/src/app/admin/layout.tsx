...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden font-sans selection:bg-orange-500/30">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="md:hidden h-16 bg-muted border-b border-border flex items-center justify-between px-6 z-40">
          <div className="text-sm font-black text-foreground uppercase tracking-tighter flex items-center gap-2">
            <span className="w-6 h-6 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex justify-center items-center text-[10px] text-white">YP</span>
            Admin
          </div>
          <button 
