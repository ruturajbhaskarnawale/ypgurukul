...
export const SuccessSummaryStep: React.FC<StepProps> = ({ data, onBack }) => {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="p-10 border-2 border-primary/20 bg-primary/5 rounded-[4rem] text-center space-y-6">
      ...
      <div className="flex justify-between items-center pt-12 border-t border-border mt-12">
        ...
        <button 
          ...
          className="bg-foreground text-background px-16 py-6 rounded-full font-black uppercase text-[12px] tracking-[0.6em] hover:bg-muted-foreground transition-all duration-300 shadow-2xl active:scale-95 flex items-center gap-4"
        >
